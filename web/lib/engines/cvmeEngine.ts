  ...
  const rules: SignalRule[] = [
    {
      ...
      terms: [
        ...
        "negociación",
        "bajar tensiones",
        "cuidar vínculos institucionales",
        "sosteniendo vínculos",
        "representando posiciones",
        "alinear intereses entre áreas",
        "alinear intereses entre sectores",
        "lectura de actores",
      ],
      sourceFields: [
    ...
    },
    {
      ...
      sourceFields: [
        {
          source: "childhood_memory",
          value: intake.narrative.childhoodMemories,
        },
        { source: "work_pattern", value: intake.narrative.repeatedWorkPatterns },
        { source: "current_context", value: currentContextText },
