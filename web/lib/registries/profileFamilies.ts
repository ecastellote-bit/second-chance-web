...
export const PROFILE_FAMILIES: ProfileFamilyDefinition[] = [
  ...
  {
    id: "scientific_investigator",
    label: "Scientific Investigator",
    summary: "Investiga, experimenta, valida hipótesis y produce conocimiento nuevo mediante método.",
    ...
    tensionAffinities: ["influence_negotiation", "public_expression"],
    subtypeCandidates: ["empirical_researcher", "lab_scientist", "field_investigator", "data_discoverer"],
    misreadAs: ["analytical_strategist", "cultural_explorer", "system_designer"],
  },
  {
    id: "body_care_healer",
    label: "Body Care Healer",
    summary: "Cuida, restaura y sana cuerpos mediante práctica directa, presencia y conocimiento corporal.",
    coreAffinities: ["care_orientation", "restorative_support", "sensory_awareness"],
    supportingAffinities: ["craft_precision", "practical_execution", "trust_building"],
    tensionAffinities: ["competitive_push", "public_expression"],
    subtypeCandidates: ["physical_therapist", "manual_healer", "health_restorer", "body_practitioner"],
    misreadAs: ["empathic_guide", "technical_builder", "experience_host"],
  },
  {
    id: "ecological_steward",
    label: "Ecological Steward",
    summary: "Protege, restaura y trabaja con sistemas vivos, tierra y equilibrio ecológico.",
    coreAffinities: ["stewardship", "protective_instinct", "sensory_awareness"],
    supportingAffinities: ["care_orientation", "duty_reliability", "exploratory_drive"],
    tensionAffinities: ["competitive_push", "influence_negotiation"],
    subtypeCandidates: ["ecosystem_restorer", "land_worker", "conservation_guardian", "sustainable_designer"],
    misreadAs: ["resource_steward", "civic_advocate", "scientific_investigator"],
  },
  {
    id: "athletic_performer",
    label: "Athletic Performer",
    summary: "Se expresa y se realiza a través del cuerpo: deporte, movimiento, rendimiento físico y disciplina corporal.",
    coreAffinities: ["physical_mastery", "discipline_endurance", "competitive_push"],
    supportingAffinities: ["energy_transmission", "pressure_functioning", "performance_presence"],
    tensionAffinities: ["conceptual_abstraction", "institutional_navigation"],
    subtypeCandidates: ["competitive_athlete", "movement_artist", "endurance_performer", "team_sport_leader"],
    misreadAs: ["artistic_creator", "technical_builder", "experience_host"],
  },
];
