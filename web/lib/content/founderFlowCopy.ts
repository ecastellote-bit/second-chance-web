export const FOUNDER_FLOW_COPY = {
  landing: {
    ...
    secondaryCta: "Ir al barrio",
    exploreBarrioCta: "Explorar el barrio primero",
  ...
  fullIntro: {
    ...
    description:
      "No es un test ni un formulario para lucirte. Es una lectura seria de tu historia: te orienta mejor y prepara tu entrada al barrio para que tus próximos movimientos no sean al azar.",
    bullets: [
  ...
  gate: {
    ...
    body: "Para sembrar la Comunidad y acceder como fundador, necesitás completar la lectura hasta el resultado.",
    cta: "Hacer mi lectura inicial",
  },
  sembrar: {
